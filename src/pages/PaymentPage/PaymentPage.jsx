...
//       NguoiDung: user?.id,
//       DaThanhToan: true,
//       NgayThanhToan: details.update_time,
//     });
//   };
...
//                     <PayPalButton
//                       // amount="0.01"
//                       // amount={(totalPrice / 30000).toFixed(2)}
//                       // amount={totalPrice}
                ...
                >
                  ...
                  {payment === "PayPal" && sdkReady ? (
                    <PayPalScriptProvider
                      options={{
                        "client-id":
                          "AQbhxxQkdAmt6dw9F5LKYTiR9EGFM18PrsP5HuC_um3RqC3iPHsOsUXcsc0U2efKmClmUMY7NJ0Xq2Le",
                      }}
                    >
                      <PayPalButtons
                        ...
                        createOrder={(data, actions) => {
                          return actions.order.create({
                            purchase_units: [
                              {
                                amount: {
                                  value: (totalPrice / 30000).toFixed(2),
                                },
                              },
                            ],
                          });
